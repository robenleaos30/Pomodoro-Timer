...
button = Button(text="Start", width=7, command=start_timer)
button.grid(column=0, row=2)

button1 = Button(text="Reset", width=7, command=reset_timer)
button1.grid(column=2, row=2)

mark = Label(fg=GREEN, font=(FONT_NAME, 15), bg=YELLOW)
